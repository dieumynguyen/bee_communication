...
class Plotter(object):
    ...
    def display_environment_map(self, concentration_map, time_i, timestep, init):
        ...
        # Nov20 DM changed cbar=True
        sns.heatmap(concentration_map, cbar=True, cmap=self.concentration_cmap, ax=self.concentration_map, vmin=0, vmax=self.vmax, xticklabels=0, yticklabels=0)
